...
LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="Trifid ld.zazuko.com" \
      org.label-schema.description="Sample Trifid instance" \
      org.label-schema.url="https://ld.zazuko.com" \
      org.label-schema.vcs-url="https://github.com/zazuko/ld.zazuko.com" \
